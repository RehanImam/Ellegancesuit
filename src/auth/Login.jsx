  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center bg-[#fff8fa] px-4 py-12">
      <div className="w-full max-w-md bg-white/80 backdrop-blur-md rounded-3xl p-8 border border-pink-200/60 shadow-lg shadow-pink-100/50">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-xs font-semibold text-rose-950 uppercase tracking-wider">
                Password
              </label>
              <Link
                to="/forgot-password"
                className="text-xs font-medium text-pink-600 hover:text-rose-900 transition"
              >
                Forgot Password?
              </Link>
            </div>
        ...
        {/* Footer Link */}
        <p className="text-center text-xs text-rose-950/80 mt-8">
