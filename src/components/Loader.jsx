    ...
    <div className="fixed inset-0 z-[9999] bg-[#fff8fa] flex items-center justify-center">
      <div className="flex flex-col items-center">
        ...
        <div className="relative">
          ...
          <div className="relative w-24 h-24 rounded-full overflow-hidden border-2 border-pink-400/60 shadow-2xl bg-rose-950 flex items-center justify-center">
            <img 
              src={logoImg} 
        ...
        <div className="flex items-center gap-2 mt-6">
          ...
          <span className="text-sm font-medium text-rose-900/70">
        ...
        {/* Progress Bar */}
        <div className="w-48 h-1 bg-pink-200/60 rounded-full overflow-hidden mt-4">
          <div className="h-full w-1/2 bg-gradient-to-r from-pink-600 to-rose-900 rounded-full animate-[loader_1.5s_ease-in-out_infinite]" />
        </div>
